...
public class HomeFragment extends Fragment implements IMoview, BGARefreshLayout.BGARefreshLayoutDelegate, BasePullLayout.OnPullCallBackListener {
...
//        bgaRefresh.setRefreshViewHolder(refreshViewHolder);
    ...
    public void loadBtData(RecentUpdate result) {
        ...
        LAdapter adapter = new LAdapter(getContext(), (ArrayList<RecentUpdate.DataBean>) result.getData(), vp);
