...
import com.ess.filepicker.activity.SelectFloderByBrowserActivity;
...
public final class SelectCreator {
    ...
    public void start() {
        ...
        }else if (SelectCreator.this.chooseType.equals(SelectOptions.CHOOSE_TYPE_FLODER)) {
            intent.setClass(activity, SelectFloderByBrowserActivity.class);
        } else {
            return;
        }
