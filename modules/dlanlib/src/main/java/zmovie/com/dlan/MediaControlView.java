 ...
 * @date 2018/11/6
 */
public class MediaControlView extends Dialog implements View.OnClickListener {
    ...
    private void play() {
        if (ControlManager.getInstance().getState() == ControlManager.CastState.STOPED) {
            ...
            Toast.makeText(getContext(), "正在连接设备，稍后操作", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        ControlManager.getInstance().newPlayCast(localItem, new ControlCallback() {
            ...
            public void onSuccess() {
                ...
                playView.post(new Runnable() {
                    ...
                    public void run() {
                        playView.setText("暂停");
                        Toast.makeText(getContext(), "播放已开始", Toast.LENGTH_SHORT).show();
                    }
                });
            }
