...
/**
 * creator huangyong
 * createTime 2019/3/16 上午10:14
 * path com.huangyong.playerlib.widget
 * description:
 */
public class MyIjkDecoder extends BaseInternalPlayer {



    private final String TAG = "MyIjkPlayer";
...
//        ijkMediaPlayer.native_setLogLevel(IjkMediaPlayer.IJK_LOG_DEBUG);
        ...
        ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "protocol_whitelist", "ffconcat,file,http,https,tcp,udp,tls,rtp,rtmp,hls");
        //accurate seek
