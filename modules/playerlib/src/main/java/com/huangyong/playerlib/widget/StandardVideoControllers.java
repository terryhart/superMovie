...
public class StandardVideoControllers extends GestureVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private Animation mShowAnim = AnimationUtils.loadAnimation(getContext(), com.dueeeke.videocontroller.R.anim.dkplayer_anim_alpha_in);
    private Animation mHideAnim = AnimationUtils.loadAnimation(getContext(), com.dueeeke.videocontroller.R.anim.dkplayer_anim_alpha_out);
    ...
    public StandardVideoControllers(@NonNull Context context) {
        this(context, null);
    }

    public StandardVideoControllers(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StandardVideoControllers(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
...
//        FrameLayout pip2picCover = (FrameLayout) View.inflate(getContext(), R.layout.layout_pip2pic_cover, this);
//        pip2picCover.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (changeListener!=null){
//                    changeListener.startFlow();
//                }
//            }
//        });
    }
...
//                mLoadingProgress.setVisibility(GONE);
    ...
    protected void doLockUnlock() {
        if (mIsLocked) {
            ...
            show();
            mLockButton.setSelected(false);
            Toast.makeText(getContext(), com.dueeeke.videocontroller.R.string.dkplayer_unlocked, Toast.LENGTH_SHORT).show();
        } else {
            hide();
            mIsLocked = true;
            mIsGestureEnabled = false;
            mLockButton.setSelected(true);
            Toast.makeText(getContext(), com.dueeeke.videocontroller.R.string.dkplayer_locked, Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onBackPressed() {
        if (mIsLocked) {
            show();
            Toast.makeText(getContext(), com.dueeeke.videocontroller.R.string.dkplayer_lock_tip, Toast.LENGTH_SHORT).show();
            return true;
        }
